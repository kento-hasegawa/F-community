        ...
        <div class="container col-lg-6 col-md-8 col-sm-10 col-xs-11 mx-auto my-5">
            <div class="card mt-5">
                <div class="card-body text-center">
                    <h2 class='h4 card-title text-center mt-5 mb-1'><span class="bg green accent-4 text-white py-3 px-4 rounded-pill">プロフィール編集</span></h2>
                        ...
                        <div class="card-body align-items-center text-center mt-2 mb-3">
                            <form action="{{ route('users.update', ['name' => $user->name]) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="md-form col-lg-6 col-md-7 col-sm-8 col-xs-10 mx-auto">
                                    ...
                                    <input　type="text" class="form-control" id="selfintroduction" name="selfintroduction" required value="{{ $user->selfintroduction }}">
                                </div>
                                <button type="submit" class="btn btn-block green accent-4 text-white col-lg-6 col-md-7 col-sm-8 col-xs-10 mx-auto mt-5 waves-effect">
                                    更新する
                                </button>
                                <div class="mx-auto">
