        ...
        <div class="mx-auto col-12 col-sm-11 col-md-9 col-lg-7 col-xl-6 my-5">
            <div class="card mt-5">
                <div class="card-body text-center">
                    <h2 class='h4 card-title text-center mt-5 mb-1'><span class="bg green accent-4 text-white py-3 px-4 rounded-pill">パスワード変更</span></h2>
                    ...
                    <div class="card-text mt-5">
                        <form method="POST" action="{{ route('users.password.update', ['name' => $user->name]) }}">
                            ...
                            <button class="btn btn-block green accent-4 text-white col-lg-8 col-md-9 col-sm-10 col-xs-12 mx-auto mt-4 mb-5" type="submit">
                                変更する
                            </button>
                        </form>
